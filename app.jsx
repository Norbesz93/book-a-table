...
const App = () => {
    return (
        <div>
            <img id="logo" src="/pizzahut.jpeg" alt="pizza hut logo"/>
            ...
            <nav id="nav">
                <div id="intro"> 
                    <p id="text">
                        ...
                        The chain has 18,703 restaurants worldwide as of December 31, 2019,[2] making it the world's largest pizza chain in the number of locations.
